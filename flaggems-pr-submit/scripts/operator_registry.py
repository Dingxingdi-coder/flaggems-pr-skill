...
数据源:
    - /data/dxd/规范名.xlsx      → 规范命名映射 + PR 链接回填
    - /data/dxd/第一批pr算子.xlsx → 待提交算子列表 + 加速比
...
NORM_XLSX = os.environ.get("FLAGGEMS_NORM_XLSX", "/data/dxd/规范名.xlsx")
PR_XLSX = os.environ.get("FLAGGEMS_PR_XLSX", "/data/dxd/第一批pr算子.xlsx")
