...
- **全部用英文**
- Performance 数据必须来自 `--level core` benchmark 或 `gen_pr_description.py` 脚本
...
- Testing 段统一写 "Validated against PyTorch reference on device side"
- 如果 benchmark 输出含 TFLOPS，也要加到 Performance 表格
