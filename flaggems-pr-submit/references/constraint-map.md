...
| Accuracy test correctness, reference conversion, NaN handling, statistical validation | Soft | `implementation-review/spec.md` and reviewer-learned rules | `implementation-review`, `worktree-test-benchmark`, `final-validation` |
